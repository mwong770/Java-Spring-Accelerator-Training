/**
 * Reads pets from a file, asks user to pick a pet to write to a file,
 * then writes the chosen pet to a file.
 * Handles multiple exceptions with try/catch.
 * @params args
 *
 */
...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Something went wrong while writing to your file.");
